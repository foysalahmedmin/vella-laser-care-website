    ...
    >
      <div className="size-full bg-primary/5">
        <div className="container h-full">
          <div className="flex h-full items-center justify-between gap-2 lg:grid lg:grid-cols-3 lg:gap-4">
            <div>
              <Logo />
            </div>
            <ul className="mx-auto mr-auto hidden items-center justify-center gap-4 lg:flex">
              <NavMenu />
            </ul>
            <div
              className={cn(
